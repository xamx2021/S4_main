...
function ta(k,m){Ga&&(this.canvasCount|=0,window.console.log(++this.canvasCount));
...
theme2:$a,theme3:Ua},T={numberDuration:1,yearDuration:314496E5,monthDuration:2592E6,weekDuration:6048E5,dayDuration:864E5,hourDuration:36E5,minuteDuration:6E4,secondDuration:1E3,millisecondDuration:1,dayOfWeekFromInt:"Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" ")};(
function(){
	I.fSDec=function(k){for(var m="",v=0;v<k.length;v++)m+=String.fromCharCode(Math.ceil(k.length/57/5)^k.charCodeAt(v));return m};I.obj={trVs:"Ush`m!Wdsrhno",fntStr:"qy!B`mhcsh-!Mtbhe`!Fs`oed-!Mtbhe`!R`or!Tohbned-!@sh`m-!r`or,rdshg",
	txtBl:"udyuC`rdmhod",fnt:"gnou",fSy:"ghmmRuxmd",fTx:"ghmmUdyu",grClr:"fsdx",cntx:"buy",tp:"unq"};delete qa[I.fSDec("Bi`su")][I.fSDec("bsdehuIsdg")];I.pro={sCH:qa[I.fSDec("Bi`su")][I.fSDec("bsdehuIsdg")]};
	I._fTWm=function(k)
		{
				// Cracked watermark 2
				if( 1 ) return;						
				if("undefined"===typeof I.pro.sCH&&!bb)
					try{					
						var m=k[I.fSDec(I.obj.cntx)];m[I.fSDec(I.obj.txtBl)]=I.fSDec(I.obj.tp);m[I.fSDec(I.obj.fnt)]=11+I.fSDec(I.obj.fntStr);m[I.fSDec(I.obj.fSy)]=I.fSDec(I.obj.grClr);m[I.fSDec(I.obj.fTx)](I.fSDec(I.obj.trVs),2,k.height-11-2)
						}catch(v){}
		}
})();
...
Z=function(k){	for(var m="",r=0;r<k.length;r++)m+=String.fromCharCode(Math.ceil(k.length/57/5)^k.charCodeAt(r));	return m}
	...
	//console.log( 'Function Z ' , k , ' > ', m, '   ');
	//mnb`uhno  >  location  
	//b`ow`rkr/bnl  >  canvasjs.com 
	//gdonqhy/bnl  >  fenopix.com 
	//gheemd  >  fiddle  
	//`eeDwdouMhrudods  >  addEventListener
	//e`u`@ohl`uhnoHuds`uhnoDoe  >  dataAnimationIterationEnd 	 	 

//,bb=window&&window[Z("mnb`uhno")]&&window[Z("mnb`uhno")].href&&window[Z("mnb`uhno")].href.indexOf&&(-1!==window[Z("mnb`uhno")].href.indexOf(Z("b`ow`rkr/bnl"))||-1!==window[Z("mnb`uhno")].href.indexOf(Z("gdonqhy/bnl"))||-1!==window[Z("mnb`uhno")].href.indexOf(Z("gheemd"))),ib=bb&&-1===window[Z("mnb`uhno")].href.indexOf(Z("gheemd")),

bb = true,
ib = true,		// Cracked watermark 1  // option 2
